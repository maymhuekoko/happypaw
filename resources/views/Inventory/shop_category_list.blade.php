                            ...
                            <tr>
                                ...
                                <div class="modal fade" id="edit_item{{$category->id}}" role="dialog" aria-hidden="true">
                                  ...
                                  <div class="modal-header">
                                    <h4 class="modal-title pinkcolor">Edit Shop Category Form</h4>
                                    ...
                                    <div class="modal-body">
                                        <form class="form-material m-t-40" method="post" action="{{route('shop_category_update', $category->id)}}">
                                            @csrf
    ...
    <div class="col-md-4">
        <div class="card shadow">
            <div class="card-body">
                ...
                <form class="form-material m-t-40" method="post" action="{{route('shop_category_store')}}">
                    @csrf
                    <div class="form-group">
                        <label class="font-weight-bold">Code</label>
                        <input type="number" name="category_code" class="form-control @error('category_code') is-invalid @enderror" placeholder="enter shop category code">
