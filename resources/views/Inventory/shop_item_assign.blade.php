...
<div class="row">
    ...
    <div class="col-2">
        <button type="button" id="assign_btn" class="btn btn-primary">Assign Item</button>
    </div>
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-header">

                <h4 class="font-weight-normal mt-2">Item List</h4>
                                        ...
                                        <tbody id="item">
                                            ...
                                            <tr>
                                                ...
                                                @php
                                                    $checked="";
                                                @endphp
                                                <td>{{$item->shop_item_code}} , {{$item->id}}</td>
            ...
            success:function(data){
                ...
                if(data){
                    ...
                    $.each(data,function(i,v){
                        if(typeof(v.shop_sub_category) != "undefined" && v.shop_sub_category !==null){

                            var subcategory_name = v.shop_sub_category.name;
                        }
                        else{
                        ...
                        <tr>
                            ...
                            @php
                                $checked="";
                            @endphp
                            <td>${v.shop_item_code} , ${v.id}</td>
                            <td>${v.shop_item_name}</td>
                            <td>${v.shop_category.category_name ?? ""}</td>
