@extends('master')
@section('title', 'ShopSubcategory')
@section('content')


<div class="col-md-5 col-8 align-self-center">
    <h3 class="text-themecolor m-b-0 m-t-0">Shop SUB CATEGORY</h3>
...
<div class="row mt-5">
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-body">
                <h4 class="card-title">Shop Sub Category Lists</h4>
                    ...
                    <table class="table">
                        ...
                        <?php $i=1;
                            ...
                            <td>{{$i++}}</td>
                                ...
                                <td>{{$sub_category->shop_category->category_name}}</td>
                                ...
                                <div class="modal fade" id="edit_subcategory{{$sub_category->id}}" role="dialog" aria-hidden="true">
                                  ...
                                  <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-material m-t-40" method="post" action="{{route('shop_sub_category_update', $sub_category->id)}}">
                                            @csrf
    ...
    <div class="col-md-4">
        <div class="card shadow">
            <div class="card-body">
                ...
                <form class="form-material m-t-40" method="post" action="{{route('shop_sub_category_store')}}">
                    @csrf
                    <div class="form-group">
                        <label class="font-weight-bold">Code</label>
                        <input type="number" name="sub_category_code" class="form-control @error('category_code') is-invalid @enderror" placeholder="">
                    ...
                    <div class="form-group">
                        <label class="font-weight-bold">SubcategoryName</label>
                        <input type="text" name="sub_category_name" class="form-control @error('sub_category_name') is-invalid @enderror" placeholder="">
