        ...
        <div class="card shadow p-2">
            <div class="row" id="doc_info">
                ...
                <div class="col-sm-3 col-3 text-center">
                    ...
                    <span class="custom-badge  status-blue" id="doc_dept">{{$patient->breed}}</span><a href="/patient-profile/{{$patient->id}}" class="btn btn-warning ml-2 text=white"><i class="fas fa-edit text-white"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="row ml-auto pr-4">
        ...
        <a class="btn bbluecolor text-white mt-2" href="/vaccine-record/{{$patient->id}}">Vaccine Record</a>
    </div>
