        ...
        <div class="card shadow p-2">
            <div class="row" id="doc_info">
                <div class="col-sm-3 col-3 text-center">
                    ...
                    <span class="custom-badge  status-blue" id="book_count"> {{$appointment->clinic_patient->pet_code}}</span>
                </div>
                <div class="col-sm-3 col-3 text-center">
                ...
                <div class="col-sm-3 col-3 text-center">
                    ...
                    <span class="custom-badge  status-blue" id="doc_dept">{{$appointment->clinic_patient->ownername}}</span>
                </div>
                <div class="col-sm-3 col-3 text-center">
                    <h5 class="page-title font-weight-bold text-info">Breed</h5>
                    <span class="custom-badge  status-blue" id="doc_dept">{{$appointment->clinic_patient->breed}}</span>
                </div>
            </div>
            ...
            <div class="row">
                <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="temperature" class="col-sm-4 col-form-label">Temperature<Fieldset:disabled></Fieldset:disabled></label>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-7 pt-2">
                                    <p>{{$appointmentinfo ? $appointmentinfo->weight_kg : ''}} <span class="bluecolor">kg</span></p>
                                  </div>
                                </div> 
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                <label for="weight" class="col-sm-4 col-form-label">Clinical Sings (CS)</label>
                                <div class="col-sm-7 mt-2">
                                  <p>{{$appointmentinfo ? $appointmentinfo->complaint : ''}} </p>
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="weight" class="col-sm-4 col-form-label">Procedure & Treatments</label>
                                <div class="col-sm-7 mt-2">
                            ...
                            {{-- <div class="form-group row pt-3 {{$dNoneemployee}}"> --}}
                              ...
                              <div class="form-group row">
                                <label for="weight" class="col-sm-4 col-form-label">Vaccines</label>
                                <div class="col-sm-7 mt-2">
                                  <p class="bluecolor">
                              ...
                              <div class="form-group row">
                                <label for="weight" class="col-sm-4 col-form-label">Vaccine Duration
                                </label>
                                <div class="col-sm-7 mt-2">
                                  <p class="bluecolor">
                                    @if (isset($appointmentinfo->vaccine_duration))
                              ...
                              <div class="form-group row">
                                <label for="weight" class="col-sm-4 col-form-label">Next Vaccine Date
                                </label>
                                <div class="col-sm-7 mt-2">
                                  <p class="bluecolor">
                                    @if (isset($appointmentinfo->next_vaccine_date))
                                      {{$appointmentinfo->next_vaccine_date}}
                                    @endif
                                  </p>
                                </div>
                              </div>
                              ...
                              @if ($look_pro)
                              <div class="form-group row">
                                <label for="weight" class="col-sm-4 col-form-label pinkcolor">Procedure & Treatments</label>
                                <div class="col-sm-7 mt-2">
