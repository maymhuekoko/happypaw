...
@section('content')
    ...
    @endphp
    <input type="hidden" value="{{$from_id}}" id="from_id">
    <div class="row mb-3">
...
@section('js')
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(i, unit) {
                        // $.each(unit.stockcount,function(j,stockcount){
                        //     if(stockcount.from_id==parseInt (clinic_id)){

                        //       window.stockcount = stockcount.stock_qty;
                        //       alert(stockcount);
                        //     }
                        // })
                        ...
                        $('#item_name').val(itemNamebrand);
                                    ...
                                    $.each(unit.stockcount,function(j,stockcount){
                                    if(stockcount.from_id==parseInt (clinic_id)){
                                     stockcountt = stockcount.stock_qty;
                                    }
                        })
                        ...
                        html += `<tr class="text-center">
                            ...
                            <input type="hidden" id="price_${unit.id}" value="${unit.normal_sale_price}">
                                ...
                                <td id="stock_${unit.id}">${stockcountt}</td>
        ...
        function tgPanel(id) {
            ...
            var current_qty = $('#stock_' + id).text();
            var item = {
                id: id,
                item_name: item_name,
                unit_name: name,
