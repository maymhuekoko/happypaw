...
{{-- <div class="page-wrapper"> --}}
    <div class="container-fluid">
        ...
        <div class="container row mb-5" id="eacheach">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <br>
                    <input type="date" name="paydate" class="form-control" id="paydate" value="<?= date("Y-m-d"); ?>">
                </div>
                <div class="col-md-4">
                    <button type="button" class="btn btn-outline-danger ml-1" style="margin-top:31px;" data-toggle="modal" data-target="#myModal">Pay</button>
                </div>
            </div>
